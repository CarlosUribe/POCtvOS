...
class DataProvider: ObservableObject {
  ...
  init() {
    itemLists = [
      PopularModel(page: 1, perPage: 1, totalResults: 5, url: "https://www.pexels.com/search/videos/Nature/", videos: [ VideoModel(id: 10, width: 1920, height: 1080, url: "https://www.pexels.com/video/water-crashing-over-the-rocks-1093662/", image: "https://images.pexels.com/videos/1093662/free-video-1093662.jpg?fit=crop&w=1200&h=630&auto=compress&cs=tinysrgb", duration: 8, user: User(id: 1, name: "Peter", url: "https://www.pexels.com/@peter-fowler-417939"), videoFiles: [VideoFile(id: 11, quality: "hd", fileType: "video/mp4", width: 1280, height: 720, link: "https://player.vimeo.com/external/269971860.hd.mp4?s=eae965838585cc8342bb5d5253d06a52b2415570&profile_id=174&oauth2_token_id=57447761")], videoPictures: [])
      ])
    ]
  }
}
